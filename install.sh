...
install() {
  ...
  [[ -d ${SCHEMES_DIR}/Steam.colors ]] && rm -r ${SCHEMES_DIR}/Steam.colors
  ...
  [[ ${color} == '' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/Steam.colors                                    ${SCHEMES_DIR} && \
  cp -ur ${SRC_DIR}/color-schemes/Steam.colors                                    ${PLASMA_DIR}/${name}/colors

  [[ ${color} == '-light' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/Steam.colors                               ${SCHEMES_DIR}
}

echo "Installing 'Steam kde themes'..."
